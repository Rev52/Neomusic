...
import './style/PlaylistPage.css'; // Kita REUSE (Gunakan kembali) CSS yang sama
import { useNavigate } from 'react-router-dom'; 

// Import Icons
import { 
  FaHome, FaSearch, FaThLarge, FaHeart, FaEllipsisH, 
...
const PlaylistPage = ({ onPlay }) => {
  ...
  // --- DATA KHUSUS LIKED SONGS ---
  const playlistData = {
    title: "Liked Songs",
    type: "Public Playlist",
    owner: "Jane Doe",
    totalSongs: "2 songs", // Sesuai gambar Figma
    // Gambar Cover Gradient Ungu dengan Hati
    cover: imgLikedSongs, 
    ownerImg: imgProfile
  };
  ...
  {libraryItems.map((item) => (
    ...
    >
      ...
      <main 
        ...
        // OVERRIDE BACKGROUND: Menggunakan warna ungu/biru khas Liked Songs
        style={{
          background: 'linear-gradient(180deg, rgba(80, 56, 160, 0.6) 0%, rgba(18, 12, 31, 0.95) 45%)'
        }}
      >
