...
import imgOrdinary from '../assets/images/img_ordinary.png';
  ...
  const TopSongsPage = ({ onPlay }) => { 
    ...
    // --- DATA KHUSUS TOP SONGS ---
    const playlistData = {
      title: "Top Songs - Global",
      type: "Public Playlist",
      owner: "Jane Doe",
      totalSongs: "2 songs",
      // Gambar Cover Orange/Biru Geometric (Sesuai Figma)
      cover: imgTopSongs, 
      ownerImg: imgProfile
    };
  ...
  { 
    ...
    return (
      <div className="app-container-playlist page-animate">
    ...
    >
      ...
      <div className="playlist-info">
        ...
        <main 
          ...
          // CUSTOM BACKGROUND GRADIENT (Biru agak gelap/Slate)
          style={{
            background: 'linear-gradient(180deg, rgba(60, 68, 90, 0.8) 0%, rgba(18, 12, 31, 0.98) 50%)'
          }}
        >
